...
BASE_DRIVING_REWARD = 1.60
BASE_SPEED_REWARD = 0.15
USE_LATERAL_REWARD = True

BASE_SUCCESS_REWARD = 120.0
BASE_OUT_OF_ROAD_PENALTY = 80.0
BASE_CRASH_VEHICLE_PENALTY = 60.0
BASE_CRASH_OBJECT_PENALTY = 60.0
BASE_CRASH_SIDEWALK_PENALTY = 80.0
...
BRAKE_BASE_PENALTY = 0.25
LOW_SPEED_BRAKE_THRESHOLD_KMH = 12.0
LOW_SPEED_BRAKE_EXTRA_PENALTY = 0.90
IDLE_BRAKE_THRESHOLD_KMH = 3.0
IDLE_BRAKE_EXTRA_PENALTY = 0.90

# Idle/stall behavior.
IDLE_AFTER_STEPS = 20
IDLE_SPEED_THRESHOLD_KMH = 2.0
IDLE_STEP_PENALTY = 0.08

STALL_SPEED_THRESHOLD_KMH = 2.5
STALL_THROTTLE_THRESHOLD = 0.2
STALL_AFTER_STEPS = 35
STALL_TERMINAL_REWARD = -80.0


# ---------------------------- Terminal rewards ----------------------------

FINISH_REWARD = 160.0
FALL_OFF_ROAD_REWARD = -80.0
HIT_OBSTACLE_REWARD = -60.0
HIT_TRAFFIC_REWARD = -60.0
HIT_EDGE_REWARD = -80.0
